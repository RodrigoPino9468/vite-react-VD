...
const Carousel = () => {
    return (
        <div class='container-fluid' style={{background:"#7D143B"}}>
            {/* <!-- Carousel --> */}
            <p class="Fuente-carousel d-flex flex-column justify-content-center align-items-center" style={{color:"white"}}>Noticias recientes</p>
            ...
            <div class='col-12 d-flex flex-row justify-content-center'>
                <button class="btn Fuente-Textos Boton-Redondeado" style={{background:"#B73B58", color:"white"}}>Más noticias</button>
            </div>
